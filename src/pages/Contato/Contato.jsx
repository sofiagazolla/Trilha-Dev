...
function Contato() {
	...
	const validateForm = () => {
		...
		if (!formData.name.trim()) {
			...
			newErrors.name =
				'Esse nome me parece curto demais, você pode escrever seu nome completo?';
		}
		...
		if (!formData.email.trim()) {
			...
			newErrors.email =
				'Esse e-mail não é válido. Confere se você digitou ele certinho?';
		}
		...
		if (!formData.message.trim()) {
			...
			newErrors.message =
				'Sua mensagem está curtinha demais. Pode escrever pelo menos 5 caracteres pra gente conversar melhor?';
		}
